    ...
    <nav className="fixed top-0 w-full z-50 glass-nav border-b border-ink/5">
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12 py-6 flex justify-between items-center">
        ...
        <div className="absolute left-1/2 -translate-x-1/2">
          <Link to={user?.role === 'admin' ? "/admin" : "/"} className="flex flex-col items-center justify-center group">
            <span className="text-2xl md:text-3xl tracking-[0.4em] font-light uppercase leading-none mb-1 group-hover:text-accent-brown transition-colors">Atelier</span>
