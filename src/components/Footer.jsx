  ...
  return (
    <footer className="bg-ink text-cream/80 py-20 px-6 md:px-12 border-t border-cream/10">
      <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
        <div className="space-y-6">
          <div className="flex flex-col items-start group cursor-default">
            <span className="text-2xl tracking-[0.4em] uppercase text-cream leading-none mb-1">Dresscode</span>
            <span className="text-[8px] tracking-[0.6em] uppercase font-bold text-cream/40">Atelier</span>
          </div>
      ...
      <div className="max-w-screen-2xl mx-auto mt-20 pt-8 border-t border-cream/5 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className="text-[10px] uppercase tracking-[0.2em] text-cream/40">© 2026 Dresscode Atelier. All rights reserved.</p>
