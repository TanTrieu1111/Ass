  ...
  return (
    <section className="py-32 px-6 md:px-12 max-w-screen-2xl mx-auto overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center gap-20">
        ...
        >
          <span className="font-sans uppercase text-[10px] tracking-[0.4em] text-muted-brown block">The Dresscode Heritage</span>
          ...
          <p className="text-lg leading-[1.8] text-muted-brown font-light max-w-xl">
            Founded in 1984, DRESSCODE ATELIER began with a single vision: to merge the architectural rigor of sculpture with the fluid movement of textiles. Our garments are crafted by hand in our Parisian studio, where master artisans spend hundreds of hours perfecting the silhouette of a single piece.
          </p>
          <div className="pt-6">
