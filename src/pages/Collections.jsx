...
const collections = [
  {
    id: 'bliss-collection',
    name: 'Bliss Collection',
    title: 'A Beautiful Soul',
    description: 'Story of a beautiful but lost soul. A collection that explores the delicate balance between fragility and strength through ethereal textures and soft silhouettes.',
  ...
  },
  {
    id: 'luxurious',
    name: 'Luxurious',
    title: 'Opulence & Style',
    description: 'Luxury is the pursuit of the extraordinary. This collection features the finest materials and exquisite craftsmanship, designed to elevate the senses and create a life of unparalleled comfort.',
    image: 'https://images.unsplash.com/photo-1566933265975-998818988681?auto=format&fit=crop&q=80&w=1200',
    color: 'bg-zinc-200',
    tag: '#Luxurious'
  },
  {
    ...
    name: 'Bloom or Fade',
    title: 'Your Move',
    description: 'It\'s not the future you\'re afraid of, but the repeating past. A bold collection that challenges the status quo with architectural lines and high-contrast textures.',
  ...
  {
    id: 'the-cost-of-love',
    name: 'The Cost of Love',
    title: 'Emotional Depth',
    description: 'Exploring the weight of human connection. A collection that uses heavy drapes and deep, melancholic tones to tell a story of love, loss, and resilience.',
    image: 'https://images.unsplash.com/photo-1508784411316-02b8cd4d3a3a?auto=format&fit=crop&q=80&w=1200',
    color: 'bg-stone-200',
    tag: '#TheCostOfLove'
  }
];
