...
import { Heart, ShoppingBag, Check, ChevronRight, Minus, Plus, Share2, Ruler, ArrowRight } from 'lucide-react';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        if (foundProduct && foundProduct.stockBySize) {
          const sizes = Object.keys(foundProduct.stockBySize);
          if (sizes.length > 0) {
