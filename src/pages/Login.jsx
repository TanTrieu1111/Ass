    ...
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      <header className="p-8 md:p-12 flex justify-between items-center">
        <Link to="/" className="flex flex-col items-start group">
          <span className="text-2xl tracking-[0.4em] uppercase leading-none mb-1 group-hover:text-accent-brown transition-colors">Dresscode</span>
          <span className="text-[8px] tracking-[0.6em] uppercase font-bold opacity-40 group-hover:opacity-100 transition-opacity">Atelier</span>
        </Link>
      </header>
      ...
      <footer className="p-12 flex flex-col md:flex-row justify-between items-center gap-6 border-t border-ink/5">
        <p className="text-[10px] uppercase tracking-widest text-ink/40">© 2026 Dresscode Atelier. Conscious Craftsmanship.</p>
